...
const projects = [
  ...
  },
  {
    ...
    link: "https://github.com/hithagovi/UPI-FRAUD-DETECTION",
    linkLabel: "View GitHub",
    points: [
      "Developed an XGBoost model to detect fraudulent UPI transactions with 80%+ accuracy.",
      "Performed preprocessing and hyperparameter tuning to improve model performance.",
      "Reduced false positives through model optimization and tuning iterations.",
    ],
  },
  {
    title: "Fashion Blog",
